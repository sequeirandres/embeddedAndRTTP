#ifndef _HEADER_BPM280_I2C_
#define _HEADER_BMP280_I2C_
...
void bmp280_reset() ;
int32_t bmp280_convert(int32_t temp, struct bmp280* params);
int32_t bmp280_convert_temp(int32_t temp, struct bmp280* params) ;
int32_t bmp280_convert_pressure(int32_t pressure, int32_t temp, struct bmp280* params) ;
void bmp280_get_calib_params(struct bmp280* params);
*/
